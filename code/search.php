...
<div class="text-center">
  <div class="row justify-content-center">
    <table cellpadding="30" >
      <tr>
        <td>
          <i class="fa fa-4x fas fa-certificate"></i>
        </td>
        <td>
          <img src="./img/profile.png" width="300px" height="300px">
          <h2 class="section-heading">Bobo</h2>
          <hr class="my-4">
        </td>
        <td>
        <i class="fa fa-4x fas fa-certificate"></i>
...
<div class="row justify-content-center">
          <div class="col-lg-4 text-center">
            <a class="btn btn-default btn-xl" href="offer.php">Offer a Gig</a>
          </div>
          <div class="col-lg-4 text-center">
            <a class="btn btn-default btn-xl" href="overview.php">My Page</a>
          </div>
          <div class="col-lg-4 text-center">
            <a class="btn btn-primary btn-xl" href="search.php">Take a Gig</a>
          </div>
      </div>
